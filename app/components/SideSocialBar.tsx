...
export default function SideSocialBar() {
  return (
    <aside
      ...
      className="fixed right-0 top-1/2 -translate-y-1/2 z-40 hidden md:flex flex-col items-center bg-[#0d1410]/90 backdrop-blur-md border-l border-y border-zinc-800 rounded-l-2xl py-3 px-2 shadow-2xl space-y-3"
    >
      <a
        ...
        className="p-2 text-zinc-400 hover:text-orange-400 hover:scale-110 transition-all"
      >
