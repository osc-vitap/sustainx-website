      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-zinc-800/80">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-2.5 pt-2 flex-wrap">
              <a
                ...
                className="p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-purple-500/50 hover:text-purple-400 transition-colors"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-white/50 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <div className="p-3 rounded-xl bg-[#09110d] border border-zinc-800 flex items-center justify-between gap-2 text-xs font-mono mb-2">
              <a
                href="mailto:osc@vitap.ac.in"
                className="text-zinc-300 hover:text-purple-300 truncate"
              >
                osc@vitap.ac.in
              </a>
              <button
            ...
            <p className="text-[11px] text-zinc-400 leading-relaxed mb-2">
              VIT-AP University, Inavolu, Beside AP Secretariat, Amaravati, AP 522237
            </p>
            <Link
              href="#contact"
              className="text-xs text-purple-400 hover:text-purple-300 font-mono inline-flex items-center gap-1"
            >
